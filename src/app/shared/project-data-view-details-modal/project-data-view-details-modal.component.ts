...
@Component({
  selector: 'app-project-data-view-details-modal',
  templateUrl: './project-data-view-details-modal.component.html',
  styleUrls: [
    './project-data-view-details-modal.component.scss'
  ],
...
export class ProjectDataViewDetailsModalComponent implements OnInit, OnChanges, AfterViewInit {
