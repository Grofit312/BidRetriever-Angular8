...
@Component({
  selector: "company-transaction-logs-modal",
  templateUrl: "./company-transaction-logs-modal.component.html",
  styleUrls: ["./company-transaction-logs-modal.component.scss"],
})
export class CompanyTransactionLogsModalComponent implements OnInit {
  @ViewChild("transactionLogsModal", { static: false })
  transactionLogsModal: ElementRef;
