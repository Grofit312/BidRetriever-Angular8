...
@Component({
  selector: 'app-company-data-view-modal',
  templateUrl: './company-data-view-modal.component.html',
  styleUrls: ['./company-data-view-modal.component.scss'
],
...
export class CompanyDataViewModalComponent implements OnInit {
  ...
  isCompanyDataViewDetailsModalShown = false;
  companyDataViewDetailsModalTitle = '';
  companyDataViewDetailsModalMode = 'create';
  companyDataViewDetailsModalCurrentViewId = null;
  companyDataViewDetailsModalOpenedTime = null;
  ...
  constructor(
    ...
    this.dataViewGridDataSource = new CustomStore({
      ...
      load: () => new Promise((resolve, reject) => {
        ...
        this._dataViewApiService.findDataViews('company', this._dataStore.currentCustomer.customer_id)
          .then((viewTypes: any[]) => {
  ...
  popupDetailsViewApplyAction() {
    this.isCompanyDataViewDetailsModalShown = false;
  ...
  toolbarEditViewAction() {
    ...
    this.companyDataViewDetailsModalTitle = 'Edit View';
    this.companyDataViewDetailsModalMode = 'edit';
    this.companyDataViewDetailsModalCurrentViewId = selectedRowKeys[0];
    this.companyDataViewDetailsModalOpenedTime = new Date();
    this.isCompanyDataViewDetailsModalShown = true;
  }

  toolbarAddViewAction() {
    this.companyDataViewDetailsModalTitle = 'Create View';
    this.companyDataViewDetailsModalMode = 'create';
    this.companyDataViewDetailsModalCurrentViewId = '';
    this.companyDataViewDetailsModalOpenedTime = new Date();
    this.isCompanyDataViewDetailsModalShown = true;
  }
