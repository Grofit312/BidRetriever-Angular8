...
export const AnalyticTypeLabels: Record<EAnalyticTypes, string> = {
  [EAnalyticTypes.Company]: 'Company',
  [EAnalyticTypes.Project]: 'Project',
  [EAnalyticTypes.Office]: 'Office',
  [EAnalyticTypes.Customer]: 'Customer',
  [EAnalyticTypes.User]: 'User',
};
